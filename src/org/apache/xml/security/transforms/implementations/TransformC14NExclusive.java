...
public class TransformC14NExclusive extends TransformSpi
{
    ...
    throws CanonicalizationException
  {
    try
    {
      ...
      Object localObject1 = new Canonicalizer20010315ExclOmitComments();
      if (paramOutputStream != null)
        ((Canonicalizer20010315ExclOmitComments)localObject1).setWriter(paramOutputStream);
      Object localObject2 = paramXMLSignatureInput.getExcludeNode();
      byte[] arrayOfByte = paramXMLSignatureInput.isElement() ? ((Canonicalizer20010315ExclOmitComments)localObject1).engineCanonicalizeSubTree(paramXMLSignatureInput.getSubNode(), str, (Node)localObject2) : paramXMLSignatureInput.isOctetStream() ? ((Canonicalizer20010315ExclOmitComments)localObject1).engineCanonicalize(paramXMLSignatureInput.getBytes()) : ((Canonicalizer20010315ExclOmitComments)localObject1).engineCanonicalizeXPathNodeSet(paramXMLSignatureInput.getNodeSet(), str);
 ...
 * Qualified Name:     org.apache.xml.security.transforms.implementations.TransformC14NExclusive
